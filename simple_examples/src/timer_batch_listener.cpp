...
class TimerBatchListener : public rclcpp::Node
{
public:
  SIMPLE_EXAMPLES_PUBLIC
  explicit TimerBatchListener(const rclcpp::NodeOptions & options)
  : Node("timer_batch_listener", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(simple_examples::TimerBatchListener)
