...
{
// Create a TimerListenerUsingCallbackStraight class that subclasses the generic rclcpp::Node base class.
// The main function below will instantiate the class as a ROS node.
class TimerListenerUsingCallbackStraight : public rclcpp::Node
{
public:
  SIMPLE_EXAMPLES_PUBLIC
  explicit TimerListenerUsingCallbackStraight(const rclcpp::NodeOptions & options)
  : Node("timer_listener_using_callback_straight", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(simple_examples::TimerListenerUsingCallbackStraight)
