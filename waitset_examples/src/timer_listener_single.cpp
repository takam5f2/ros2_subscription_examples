...
{
// Create a TimerListenerSingle class that subclasses the generic rclcpp::Node base class.
// The main function below will instantiate the class as a ROS node.
class TimerListenerSingle : public rclcpp::Node
{
public:
  WAITSET_EXAMPLES_PUBLIC
  explicit TimerListenerSingle(const rclcpp::NodeOptions & options)
  : Node("timer_listener_single", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(waitset_examples::TimerListenerSingle)
